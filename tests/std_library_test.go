...
// tree-walker/bytecode x hari/kanade (they share one implementation in
	...
	runTypeCases(t, []typeCase{
		{
			...
			hari:       hariJSON + "'값'을 <파싱>(\"{\\\"a\\\": [1, {\\\"b\\\": true}], \\\"c\\\": null}\")로 정하자\n'값'을 출력하자\n",
	...
	runTypeCases(t, []typeCase{
		{
			...
			hari:   hariDate + "<서식>(<읽기>(\"2024-03-05 07:08:09\", \"YYYY-MM-DD HH:mm:ss\"), \"YYYY/MM/DD HH:mm:ss\")를 출력하자\n",
		...
		},
		{
			...
			hari:   hariDate + "<서식>(<읽기>(\"2024-03-05\", \"YYYY-MM-DD\"), \"YYYY년 MM월 DD일\")을 출력하자\n",
